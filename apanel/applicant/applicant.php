<?php
$moduleTablename = "tbl_giftvoucher"; // Database table name
$moduleId = 32;              // module id >>>>> tbl_modules
$moduleFoldername = "";     // Image folder name
if (isset($_GET['page']) && $_GET['page'] == "giftvoucher" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ?>
    <h3>List of giftvoucher</h3>
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php
                $records = giftvoucher::find_by_sql("SELECT * FROM tbl_giftvoucher ORDER BY sortorder DESC");
                ...
                <tr id="<?php echo $record->id; ?>">
                    ...
                    <td class="text-center">
                        <a href="javascript:void(0);" class="loadingbar-demo btn small bg-blue-alt tooltip-button" data-placement="top" title="View detail"
                           onclick="editgiftvoucher(<?php echo $record->id; ?>);">
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEditgiftvoucher"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        $appId = addslashes($_REQUEST['id']);
        $appInfo = giftvoucher::find_by_id($appId);
    endif;
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'View giftvoucher' : 'View giftvoucher'; ?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
        ...
        <tbody>
        <?php $record = giftvoucher::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
        ?>
