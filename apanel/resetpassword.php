...
<body>
    ...
    <div class="pad20A">
        <div class="row">
            <div class="clear"></div>
            <!-- For Reset Password  -->
            <form action="" name="reset-frm" id="reset-frm" class="col-md-3 center-margin form-vertical mrg25T"
                method="post">
                <?php if ($dataResult) {
                    ...
                    <div class="ui-dialog mrg5T " id="login-reset" style="position: relative !important;">
                        <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
                            ...
                            <a href="<?php echo ADMIN_URL; ?>" class="switch-button" style="float:right;"
                                title="Back To Login">
                        ...
                        <div class="pad20A ui-dialog-content ui-widget-content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input col-md-10">
                                    <div class="form-input-icon">
                                        <i class="glyph-icon icon-unlock-alt ui-state-default"></i>
                                        <input placeholder="Re-password" type="password" id="re-password"
                        ...
                        <div class="ui-dialog-buttonpane text-center">
                            <button type="submit" name="submit" class="btn large primary-bg radius-all-4 btn-reset"
                                id="submit">
