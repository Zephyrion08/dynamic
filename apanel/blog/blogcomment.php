<?php
$moduleTablename = "tbl_blogcomment"; // Database table name
$moduleId = 28;                // module id >>>>> tbl_modules
$moduleFoldername = "";        // Image folder name
if (isset($_GET['page']) && $_GET['page'] == "blog" && isset($_GET['mode']) && $_GET['mode'] == "blogcomment"):
    ?>
    <h3>
        List blogcomments
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="addNewblogcomment();">
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = blogcomment::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        $blogcommentId = addslashes($_REQUEST['id']);
        $blogcommentInfo = blogcomment::find_by_id($blogcommentId);
        $status = ($blogcommentInfo->status == 1) ? "checked" : " ";
        $unstatus = ($blogcommentInfo->status == 0) ? "checked" : " ";
    endif;
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit blogcomment' : 'Add blogcomment'; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);"
           onClick="viewblogcommentList();">
    <span class="glyph-icon icon-separator">
    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="blogcomment_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Title" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="title" id="title"
                               value="<?php echo !empty($blogcommentInfo->title) ? $blogcommentInfo->title : ''; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        ...
                        <textarea name="content" id="content"
                                  class="large-textarea validate[required]"><?php echo !empty($blogcommentInfo->content) ? $blogcommentInfo->content : ""; ?></textarea>
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue"
                       value="<?php echo !empty($blogcommentInfo->id) ? $blogcommentInfo->id : 0; ?>"/>
            </form>
        </div>
    </div>
    <script>
