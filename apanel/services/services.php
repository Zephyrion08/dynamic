...
$service_types = array(1 => 'Service\'s', 2 => 'Main Service\'s');
...
// clearImages($moduleTablename, "services/thumbnails");
    ...
    $typeid = (!empty($session->get('type_id_service'))) ? $session->get('type_id_service') : 1;
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
            <?php $records = Services::find_by_sql("SELECT * FROM " . $moduleTablename . " WHERE service_type=$typeid ORDER BY sortorder ASC ");
            // pr($typeid);
        ...
        <div class="example-code">
            ...
            <input type="hidden" name="type" value="<?php echo $typeid; ?>"/>
                ...
                <div class="form-row add-image">
                    <div class="form-label col-md-2">
                        <label for="">
                     <?php if(($typeid == 2) || ($typeid == 3)){?>Banner<?php }?> Image :
                        </label>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-checkbox-radio col-md-9">
                        <?php $saved_src = !empty($advInfo->linksrc) ? $advInfo->linksrc : ""; ?>
                        ...
                        <div class="form-label col-md-6">
                            ...
                            <div class="form-input">
                                <textarea name="brief" id="brief"
                                          class="medium-textarea"><?php echo !empty($advInfo->brief) ? $advInfo->brief : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                <div class="form-row">
