    ...
    <div class="example-box">
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Sub Title" class="col-md-6 validate[required,length[0,200]]" 
                    type="text" name="sub_title" id="sub_title" value="<?php echo !empty($articlesInfo->sub_title)?$articlesInfo->sub_title:"";
                ?>">
                </div>                
            </div>  
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Google Embeded link"
                           ...
                           value="<?php echo !empty($articlesInfo->google_embeded) ? htmlspecialchars($articlesInfo->google_embeded, ENT_QUOTES) : ""; ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-2">
