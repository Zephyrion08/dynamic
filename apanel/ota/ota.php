                ...
                <tbody>
                    ...
                    foreach ($records as $record): ?>
                        ...
                        <tr id="<?php echo $record->id; ?>">
                            ...
                            <td>
                                <div class="col-md-1">
                                    <a href="javascript:void(0);" onClick="editRecord(<?php echo $record->id; ?>);"
                                        ...
                                        <img src="<?php echo IMAGE_PATH; ?>ota/<?php echo $record->image; ?>"
                            ...
                            <td>
                                <?php
                                echo !empty($record->linksrc)
                                    ? substr($record->linksrc, 0, 50)
                                    : '';
                                ?>
                            </td>
            ...
            <form action="" class="col-md-10 center-margin" id="ota_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="ota Link Title" class="col-md-4 validate[required,length[0,200]]" type="text"
                            name="title" id="title" value="<?php echo !empty($otaInfo->title) ? $otaInfo->title : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="ota Link " class="col-md-4 validate[required,length[0,250]]" type="text"
                            name="linksrc" id="linksrc"
                            value="<?php echo !empty($otaInfo->linksrc) ? $otaInfo->linksrc : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row add-image">
                            ...
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                                    ...
                                    <a class="btn small float-right" href="javascript:void(0);"
                                        onclick="deleteSavedotaimage(<?php echo $otaInfo->id; ?>);">
                    ...
                    <div id="preview_Image"><input type="hidden" name="imageArrayname"
                            value="<?php echo !empty($otaInfo->image) ? $otaInfo->image : ""; ?>" class="" /></div>
                </div>
                ...
                <input myaction='0' type="hidden" name="idValue" id="idValue"
                    value="<?php echo !empty($otaInfo) ? $otaInfo->id : 0; ?>" />
            </form>
        </div>
    </div>
