...
<head>
    ...
    <title><?php echo $GLOBALS['login']['adminPanel']; ?> <?php Config::getField('sitename'); ?> |
        <?php echo $GLOBALS['login']['signIn']; ?></title>
    ...
    <noscript>This site has features that require javascript. Follow these simple instructions to <a
            href="http://www.activatejavascript.org" target="_blank">enable JavaScript in your web
            browser</a>.</noscript>
...
<body>
    ...
    <div class="pad20A">
        ...
        <div class="row">
            <div class="clear"></div>
            <form action="" name="login-frm" id="login-frm" class="col-md-3 center-margin form-vertical mrg25T"
                method="post">
                <div id="login-form" class="content-box drop-shadow">
                        ...
                        <div class="form-row">
                            <div class="form-checkbox-radio text-right col-md-12">
                                <a href="#" class="switch-button" switch-target="#login-forgot"
                                    switch-parent="#login-form" title="Recover password">
                    ...
                    <div class="button-pane">
                        <button type="submit" name="submit"
                            class="btn large primary-bg text-transform-upr font-bold font-size-11 radius-all-4 btn-login"
                            id="demo-form-valid">
            ...
            <!-- For forget Password  -->
            <form action="" name="forget-frm" id="forget-frm" class="col-md-3 center-margin form-vertical mrg25T"
                method="post">
                <div class="ui-dialog mrg5T hide" id="login-forgot" style="position: relative !important;">
                    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
                        ...
                        <a href="#" class="switch-button" style="float:right;" switch-target="#login-form"
                            switch-parent="#login-forgot" title="Recover password">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-10">
                                <div class="form-input-icon">
                                    ...
                                    <input placeholder="Email address" type="text" name="mailaddress" id="mailaddress"
                    ...
                    <div class="ui-dialog-buttonpane text-center">
                        <button type="submit" name="submit" class="btn large primary-bg radius-all-4 btn-forget"
                            id="submit">
                            <span class="button-content">
                                Recover Password
                            </span>
