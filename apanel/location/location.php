    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="location_frm">
            ...
            <div class="form-row hide">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Whatsapp" class="col-md-6" type="text" name="whatsapp" id="whatsapp"
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Contact Info" class="col-md-6" type="text" name="contact_info2"
                        id="contact_info2"
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Whatsapp" class="col-md-6" type="text" name="whatsapp_a" id="whatsapp_a"
            ...
            <div class="form-row">
                ...
                <div class="form-checkbox-radio col-md-9">
                    <input type="radio" class="custom-radio addtype" name="location_type" id="check1" value="1" <?php
                    echo !empty($status) ? $status : "checked"; ?>>
                    <label for="">Google Map</label>
                    <input type="radio" class="custom-radio addtype" name="location_type" id="check0" value="0" <?php
                    echo !empty($unstatus) ? $unstatus : ""; ?>>
                    <label for="">Image</label>
                </div>
            </div>

            <div class="form-row <?php
            echo ($locationRow->location_type == 0) ? 'hide' : ''; ?> google-link">
                <div class="form-label col-md-2">
                    <label for="">
                        Link :
                    </label>
            ...
            <div class="form-row <?php echo ($locationRow->location_type == 1) ? 'hide' : ''; ?> image-link">
                ...
                <?php endif; ?>
                <div
                    class="form-input col-md-10 uploader1 <?php echo !empty($locationRow->location_image) ? "hide" : ""; ?>">
...
// pr($metadata);
            ...
            ?>
            <div
                class="form-row show  <?php echo (!empty($metadata->meta_keywords) || !empty($metadata->meta_description) || !empty($metadata->meta_title)) ? '' : 'hide'; ?> metadata">
