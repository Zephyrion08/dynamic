                    ...
                    <div id="page-header" class="clearfix">
                        ...
                        <div class="top-icon-bar dropdown">
                            ...
                            <div class="top-icon-bar">
                                ...
                                ?>
                                <a href="<?php echo $hotelcode?>" class="user-ico clearfix" title="LogIn : Rojai "><span><i class="glyph-icon icon-sign-out font-size-12" style="margin: 0px !important;"></i>Rojai BE</span></a>
