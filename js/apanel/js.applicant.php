<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.giftvoucher.php';
    ...
    $(document).ready(function () {
        oTable = $('#example').dataTable({
            ...
            sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.giftvoucher.php?action=sort",
    ...
    function viewgiftvoucherlist(Re) {
    ...
    function viewvacencylist() {
        window.location.href = "<?php echo ADMIN_URL?>giftvoucher/list";
    }

    /***************************************** Edit records *****************************************/
    function editgiftvoucher(Re) {
        window.location.href = "<?php echo ADMIN_URL?>giftvoucher/addEditgiftvoucher/" + Re;
    }
</script>