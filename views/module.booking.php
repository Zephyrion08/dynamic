...
if($booking_type==1) {
    ...
    <a href="'.BASE_URL.'/reservation" class="book_now_btn" target="_blank" rel="noreferrer"><button type="submit" class="btn btn-huge">
            Book Now
        </button></a>
    </div>';

    // Bottom link
    $resbtnlink.='<a class="book_now_btn" href="'.BASE_URL.'reservation" target="_blank" rel="noreferrer">Reserve now</a>';  
}

// Nepalhotel 
if($booking_type==2) {
    $resbking.='
      <section class="ul-property-filter-search booknow ul-section-spacing py-0">
            <form action="'.BASE_URL.'result.php" class="ul-property-filter-search-form wow animate__fadeInUp" target="_blank" style="visibility: visible; animation-name: fadeInUp;">
          <div class="form-group">
        <h3 class="ul-property-filter-search-title wow animate__fadeInUp mb-0">Book Now</h3>
        <small>Secure your stay</small>
         </div>
        <input value="'. $booking_code .'" type="hidden" name="hotel_code">
      <div class="form-group">
        <label for="filter-location" >Check In</label>
        <input type="text" name="hotel_check_in" id="check_in" class="form-control check_in ">

      </div>
      <div class="form-group">
        <label for="filter-location" >Check Out</label>
        <input type="text" name="hotel_check_out" id="check_out" class="form-control check_out ">
      </div>
      <div class="form-group">
        <label for="filter-price" >Promo Code</label>
        <input type="text" name="hotel_promo_code" id="promo-code" class="form-control" placeholder="Enter Promo Code">
      </div>

      <button type="submit"><span class="icon"><i class="flaticon-search"></i></span>Check Availability</button>
    </form>
    ...
    // Bottom link
    $resbtnlink.='<a href="'.BASE_URL.'result.php?hotel_code='.$booking_code.'" class="book_now_btn" target="_blank" rel="noreferrer">Reserve now</a>';
}
...
<!--================ End of Layer ================--> 
    ...
    // Bottom link
    $resbtnlink.='<a href="http://www.fastbookings.biz/DIRECTORY/'.$booking_page.'?s=results&Clusternames='.$booking_code.'&Hotelnames='.$booking_code.'" class="btn btn-medium btn-darkbrown" target="_blank" rel="noreferrer">Book now</a>';
}
...
if($booking_type==4) { 
    ...
    // Bottom link
    $resbtnlink.='<a href="http://www.booking.com/hotel/np/'.$booking_page.'?aid='.$booking_code.'" class="btn btn-medium btn-darkbrown" target="_blank" rel="noreferrer">Book now</a>';
}
