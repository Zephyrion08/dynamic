...
class Subpackage extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'slug', 'title', 'sub_title', 'detail', 'facility_title', 'feature', 'image', 'header_image', 'be_room_type', 'image2', 'image3', 'image4', 'content', 'number_room',
        ...
        'organic_food', 'occupancy', 'view', 'size', 'service', 'live_music', 'bed', 'room_size', 'room_service', 'airport_pickup', 'private_balcony', 'checkinout',
        'rojai_room_id', 'source_vid', 'three60_image');
