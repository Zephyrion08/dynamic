...
class Menu extends DatabaseObject
{
	...
	protected static $db_fields = array('id', 'name', 'linksrc', 'parentOf', 'status', 'sortorder', 'linktype', 'added_date', 'type', 'image', 'upcoming');
	...
	public static function get_parentList_bylevel($level = 1, $selid = 0, $excludeId = 0)
	{
		...
		$position = array(1 => 'Top Menu', 2 => 'Info Menu', 3 => 'Resources Menu');
	...
	// 			$sel1 = ($selid == $menuRow1->id) ? 'selected' : '';
	// 			$result .= '<option value="' . $menuRow1->id . '" ' . $sel1 . '>'
	// 				. $menuRow1->name . ' (' . $position[$menuRow1->type] . ')</option>';
